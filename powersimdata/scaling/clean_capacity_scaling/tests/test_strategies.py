...
#     CE_shortfall = target_manager_obj.CalculateCEShortfall(44500, 0)
    ...
    scaling_factor = collab.calculate_capacity_scaling()
    assert collab.targets['Pacific'].resources['solar'].prev_capacity*scaling_factor == approx(9203.75)
    assert collab.targets['Pacific'].resources['wind'].prev_capacity*scaling_factor == approx(8955)
    assert collab.targets['Atlantic'].resources['solar'].prev_capacity*scaling_factor == approx(10447.5)
    assert collab.targets['Atlantic'].resources['wind'].prev_capacity*scaling_factor == approx(10198.75)
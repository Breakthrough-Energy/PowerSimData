from powersimdata.design.clean_capacity_scaling import Resource, TargetManager
...
@patch.object(TargetManager, "calculate_prev_ce_generation", return_value=12774.16)

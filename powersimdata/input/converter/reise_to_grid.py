...
class REISEConverter(AbstractGrid):
    """Grid builder for MAT files generated by REISE and REISE.jl"""
...
class FromREISE(REISEConverter):
...
class FromREISEjl(REISEConverter):
...
def add_information_to_model(grid):
    ...
    :param powersimdata.input.converter.reise_to_grid.REISEConverter grid: grid
        produced by REISE/REISE.jl engines with missing information.
    """
...
def reindex_model(grid):
    ...
    :param powersimdata.input.converter.reise_to_grid.REISEConverter grid: grid
        produced by REISE engine to reindex.
    """
